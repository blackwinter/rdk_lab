...
module RDKLab
  ...
  autoload :API,     'rdk_lab/api'
  autoload :Article, 'rdk_lab/article'
  autoload :Cat,     'rdk_lab/cat'
  autoload :FixUp,   'rdk_lab/fixup'
  autoload :Img,     'rdk_lab/img'
  autoload :Page,    'rdk_lab/page'
  autoload :Util,    'rdk_lab/util'

end

require_relative 'rdk_lab/version'
